...
# --- Test Configuration for Character Selection ---
BASE_ADDR     = 0x0100000  # Adresse virtuelle de base de code.bin
INPUT_BIN     = Path("../files/full_padded.bin")  # Adjust path from scripts/ directory
POINTER_CSV   = Path("../files/character_selection_translated.csv")  # Test file
OUTPUT_BIN    = Path("../files/full_patched_test.bin")
...
MAX_CHAINES = 4  # Our 4 test strings
